...
public class ComponentDoor extends Block
{
    ...
    public static final PropertyEnum<ComponentDoor.EnumHingePosition> HINGE = PropertyEnum.<ComponentDoor.EnumHingePosition>create("hinge", ComponentDoor.EnumHingePosition.class);
    public static final PropertyBool POWERED = PropertyBool.create("powered");
    public static final PropertyEnum<ComponentDoor.EnumDoorHalf> HALF = PropertyEnum.<ComponentDoor.EnumDoorHalf>create("half", ComponentDoor.EnumDoorHalf.class);
    ...
    {
        return state.getValue(HALF) != ComponentDoor.EnumDoorHalf.LOWER ? state : state.withProperty(FACING, rot.rotate((EnumFacing)state.getValue(FACING)));
    }
